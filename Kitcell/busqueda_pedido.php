...
<body>
	...
	$busqueda=$_GET["busqueda"];
		...
		try{
			...
			$sql="SELECT Id_pedido, Nombre, Cantidad, Fecha FROM `pedidos` WHERE Nombre LIKE '%$busqueda%'";
		...
		while($registro=$resultado->fetch(PDO::FETCH_ASSOC)){
				...
				"<br><td> Fecha:<br></td>" . "<tr><td>" .$registro['Fecha'] ."</td></tr>"."<td><a href=index_pedidos.php>volver</a></td>".
				"<br>";
			"</tr>";
			"</center>";
			"</tbody>";
